...
setGenre();
getMovies("https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&vote_average.gte=7&with_original_language=ko&api_key=9a134c87182ea691afbebbf099bea806");
...
function setGenre() {
  ...
  genres.forEach(genre => {
    ...
    tag.addEventListener("click", () => {
      ...
      let url = "https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&vote_average.gte=7&with_original_language=ko&api_key=9a134c87182ea691afbebbf099bea806";
...
form.addEventListener("submit", e => {
  ...
  setGenre();
  if (query) {
    getMovies(`https://api.themoviedb.org/3/search/tv?with_original_language=ko&api_key=9a134c87182ea691afbebbf099bea806&query=${encodeURIComponent(query)}`);
  } else {
    getMovies("https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&vote_average.gte=7&with_original_language=ko&api_key=9a134c87182ea691afbebbf099bea806");
  }
});
...
searchInput.addEventListener("input", () => {
  ...
  debounceTimeout = setTimeout(() => {
    fetch(`https://api.themoviedb.org/3/search/tv?with_original_language=ko&api_key=9a134c87182ea691afbebbf099bea806&query=${encodeURIComponent(val)}`)
      .then(res => res.json())
      .then(data => {
