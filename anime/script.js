...
setGenre();
getMovies("https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&with_keywords=210024|287501&with_genres=16&api_key=9a134c87182ea691afbebbf099bea806");
...
function setGenre() {
  ...
  genres.forEach(genre => {
    ...
    tag.addEventListener("click", () => {
      ...
      let url = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&with_keywords=210024|287501&api_key=9a134c87182ea691afbebbf099bea806";
  ...
  movies.forEach(movie => {
    ...
    movieDiv.innerHTML = `
      ...
      <div class="overview">
        ...
        <button class="know-more" id="movie-${id}">Watch Now</button>
      </div>
    `;
    main.appendChild(movieDiv);
    movieDiv.querySelector(".know-more").addEventListener("click", () => {
      openModal(movie);
    });
  });
}
...
function openModal(movie) {
  ...
  fetch(`https://api.themoviedb.org/3/movie/${movie.id}/videos?api_key=9a134c87182ea691afbebbf099bea806`)
    .then(res => res.json())
    .then(() => {
...
form.addEventListener("submit", e => {
  ...
  setGenre();
  if (query) {
    getMovies(`https://api.themoviedb.org/3/search/movie?api_key=9a134c87182ea691afbebbf099bea806&query=${encodeURIComponent(query)}`);
  } else {
    getMovies("https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&with_keywords=210024|287501&with_genres=16&api_key=9a134c87182ea691afbebbf099bea806");
  }
});
...
searchInput.addEventListener("input", () => {
  ...
  debounceTimeout = setTimeout(() => {
    fetch(`https://api.themoviedb.org/3/search/movie?api_key=9a134c87182ea691afbebbf099bea806&query=${encodeURIComponent(val)}`)
      .then(res => res.json())
      .then(data => {
